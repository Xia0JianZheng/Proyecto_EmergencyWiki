...
public class WeaponsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ImageView panyan = view.findViewById(R.id.panyan);
        panyan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                navController.navigate(R.id.action_weaponsFragment_to_weaponInfoFragment);
            }
        });
    }
